  ...
  <div class="container">
    <div class="row">
        <section id="FAQS">
          ...
          R= En la parte superior derecha haga click en register, llene el formulario y haga click en registrar, si los datos ingresados son correctos se le redirigirá a la pantalla principal del sistema de lo contrario le invitamos a verificar los datos ingresado en el formulario. 
