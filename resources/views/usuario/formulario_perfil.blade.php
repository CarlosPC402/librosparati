...
@section('contenido')
	...
	<div class="col container">
		<form action="{{action ('UsuarioController@save_perfil')}}" method="POST" enctype="multipart/form-data">
			{{ csrf_field() }}
			...
			<input type="submit" name="operacion" class="btn btn-warning" value="Modificar">
		</form>	
	</div>
@endsection